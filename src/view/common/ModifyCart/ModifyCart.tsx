...
export function ModifyCart({ data }: ModifyCartProps) {
    ...
    return (
        <div className="w-full mt-4 p-[1px] text-[8px] font-bold text-center">
            <button
                className="float-left text-[20px] font-bold bg-pink-300 hover:bg-pink-400 rounded-lg h-7 w-9 transition-colors"
            ...
            <button
                className="float-right text-[20px] font-bold bg-pink-300 hover:bg-pink-400 rounded-lg h-7 w-9 transition-colors"
